...
class BlackScholesPricer 
{
	...
	private:
		EuropeanVanillaOption* _vanilla_option; // Pointer to the vanilla option we want to price
		EuropeanDigitalOption* _digital_option; // Pointer to the digital option we want to price
